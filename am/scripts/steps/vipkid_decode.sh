...
case $feat_type in
  delta) feats="ark:/data/kanghuanping/kaldi/src/featbin/copy-feats scp:$sdata/JOB/feats.scp ark:- | add-deltas  ark:- ark:- |";;
  lda) feats="ark:/data/kanghuanping/kaldi/src/featbin/copy-feats scp:$sdata/JOB/feats.scp ark:- | splice-feats $splice_opts ark:- ark:- | transform-feats $srcdir/final.mat ark:- ark:- |";;
