...
stage=0
nj=72         # This should be set to the maximum number of jobs you are
...
sdata=$data/split$nj
utils/split_data_new.sh $data $nj
...
num_utts=$(cat $data/text | wc -l)
awk '{print $1}' $data/text | utils/shuffle_list.pl 2>/dev/null | head -$num_utts_subset \
    > $dir/valid_uttlist
awk '{print $1}' $data/text | utils/filter_scp.pl --exclude $dir/valid_uttlist | \
   utils/shuffle_list.pl 2>/dev/null | head -$num_utts_subset > $dir/train_subset_uttlist

feats="ark:utils/filter_scp.pl --exclude $dir/valid_uttlist $sdata/JOB/feats.scp | copy-feats scp:- ark:- |"
valid_feats="ark:utils/filter_scp.pl $dir/valid_uttlist $data/feats.scp | copy-feats scp:- ark:- |"
train_subset_feats="ark:utils/filter_scp.pl $dir/train_subset_uttlist $data/feats.scp | copy-feats scp:- ark:- |"
# train_subset_feats="ark:cat $data/feats.scp | copy-feats scp:- ark:- |"
...
if [ $stage -le 3 ]; then
  ...
  $cmd $dir/log/create_valid_subset.log \
    ...
    nnet3-get-egs --num-pdfs=$num_pdfs --frame-subsampling-factor=$frame_subsampling_factor \
      ...
      ark:- "ark:$dir/valid_all.egs" || touch $dir/.error &
  $cmd $dir/log/create_train_subset.log \
    ...
    nnet3-get-egs --num-pdfs=$num_pdfs --frame-subsampling-factor=$frame_subsampling_factor \
      ...
      ark:- "ark:$dir/train_subset_all.egs" || touch $dir/.error &
  wait;
...
if [ $stage -le 4 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/get_egs.JOB.log \
    ...
    "ark:filter_scp.pl $sdata/JOB/text $dir/ali.scp | ali-to-pdf $alidir/final.mdl scp:- ark:- | ali-to-post ark:- ark:- |" ark:- \| \
