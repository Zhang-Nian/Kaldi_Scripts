...
def train(args, run_opts):
    ...
    :param args:a Namespace object with the required parameters
            obtained from the function process_args()
    :param run_opts:RunOpts object obtained from the process_args()
    :return:
    """
    ...
    common_lib.execute_command("utils/split_data_new.sh {0} {1}".format(
    ...
    if (args.stage <= -5) and (args.input_model is None):
        ...
        common_lib.execute_command(
            """{command} {dir}/log/nnet_init.log \
                    nnet3-init --srand=-2 {dir}/configs/ref.config \
                    {dir}/ref.raw""".format(command=run_opts.command,
                                             dir=args.dir))
    ...
    if args.stage <= -4 and args.egs_dir is None:
        ...
        train_lib.acoustic_model.generate_new_egs(
    ...
    [egs_left_context, egs_right_context,
     frames_per_eg_str, num_archives] = (
        common_train_lib.verify_new_egs_dir(egs_dir, feat_dim,
