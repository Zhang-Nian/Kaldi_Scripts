export KALDI_ROOT=../../thirdparty/kaldi
export PATH=$KALDI_ROOT/src/fstbin:$KALDI_ROOT/tools/openfst/bin:$KALDI_ROOT/src/gmmbin:$KALDI_ROOT/src/bin:$KALDI_ROOT/src/gmmbin:$PWD/utils/:$KALDI_ROOT/tools/openfst/bin:$PWD:$PATH
